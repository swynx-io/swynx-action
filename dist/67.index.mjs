...
__webpack_require__.d(__webpack_exports__, {
  ...
  escape: () => (/* reexport */ esm.escape),
  glob: () => (/* binding */ glob),
  globIterate: () => (/* binding */ globIterate),
  globIterateSync: () => (/* binding */ globIterateSync),
  globStream: () => (/* binding */ globStream),
  globStreamSync: () => (/* binding */ globStreamSync),
  globSync: () => (/* binding */ globSync),
  hasMagic: () => (/* reexport */ hasMagic),
  iterate: () => (/* binding */ iterate),
  iterateSync: () => (/* binding */ iterateSync),
  stream: () => (/* binding */ stream),
  streamSync: () => (/* binding */ streamSync),
  sync: () => (/* binding */ sync),
  unescape: () => (/* reexport */ esm.unescape)
});

// EXTERNAL MODULE: ./node_modules/minimatch/dist/esm/index.js + 5 modules
var esm = __webpack_require__(4611);
...
class Pattern {
     ...
     */
    isGlobstar() {
        return this.#patternList[this.#index] === esm.GLOBSTAR;
    }
    /**
...
class Ignore {
    ...
    add(ign) {
        ...
        const mm = new esm.Minimatch(ign, this.mmopts);
        for (let i = 0; i < mm.set.length; i++) {
            ...
            const m = new esm.Minimatch(p.globString(), this.mmopts);
...
class Glob {
    ...
    constructor(pattern, opts) {
        ...
        const mms = this.pattern.map(p => new esm.Minimatch(p, mmo));
...
const hasMagic = (pattern, options = {}) => {
    ...
    for (const p of pattern) {
        if (new esm.Minimatch(p, options).hasMagic())
            return true;
    }
    return false;
};
