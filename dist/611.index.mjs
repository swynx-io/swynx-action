...
__webpack_require__.d(__webpack_exports__, {
  AST: () => (/* reexport */ AST),
  GLOBSTAR: () => (/* binding */ GLOBSTAR),
  Minimatch: () => (/* binding */ Minimatch),
  braceExpand: () => (/* binding */ braceExpand),
  defaults: () => (/* binding */ defaults),
  escape: () => (/* reexport */ escape_escape),
  filter: () => (/* binding */ filter),
  makeRe: () => (/* binding */ makeRe),
  match: () => (/* binding */ match),
  minimatch: () => (/* binding */ minimatch),
  sep: () => (/* binding */ sep),
  unescape: () => (/* reexport */ unescape_unescape)
});

// EXTERNAL MODULE: ./node_modules/brace-expansion/index.js
var brace_expansion = __webpack_require__(4691);
